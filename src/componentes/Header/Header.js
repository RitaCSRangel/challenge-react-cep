    ...
    return (
        <div className="header-bar">
            ...
            <div className="header-nav">
                <Link to="/challenge-react-cep/inicio" className="header-nav-itens">Início</Link>
                <Link to="/challenge-react-cep/formulario" className="header-nav-itens">Formulário</Link>
            </div>
